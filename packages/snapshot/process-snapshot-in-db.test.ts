...
// import { createMerkleTree, config, PositionSnapshot, ParsedPositionSnapshot } from "common";
...
//     const snapshot: UserSnapshot = parsedSnapshot.map((entry: ParsedUserSnapshotEntry) => ({
...
//       where: { week_number_chain_id_source_unique_id: { week_number: 1, chain_id: config.chainId, source: "core" } },
//     });
