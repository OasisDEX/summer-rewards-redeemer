...
export const config: Config = {
  ...
  getRewardDistributions: (weekId: number, network: Network) => {
    ...
    if (weekId >= config.rewardStartWeek + 49) {
      switch (network) {
        case Network.Mainnet:
          rewardDistributions = [
            { name: "RETH-DAI", address: "0x9cdB48FcBd8241Bb75887AF04d3b1302c410F671", share: .06 },
            { name: "WBTC-DAI", address: "0x50f1C63f3AEfD60C665eF45aA74f274dABf93405", share: .06 },
            { name: "WSTETH-DAI", address: "0xcD261cd365389A58e6467bb8a83A9E437864e8E5", share: .06 },
            { name: "ETH-USDC", address: "0xE4BfB9b344A0Ae89702184281F13A295F3D49e15", share: .025 },
            { name: "WBTC-USDC", address: "0x3BB7C1E268A51b2D933C0490e282e20b906f8652", share: .06 },
            { name: "WSTETH-USDC", address: "0xF5B1AD7F82549c2BBf08AAa79c9eFC70C6E46b06", share: .04 },
            { name: "USDC-ETH", address: "0x2Ceb74Bb7a92D652C850C16F48547aa49F8bca31", share: .02 },
            { name: "USDC-WBTC", address: "0xE92Cd0ACF334D1133551bC4c87eA73BbC49Ce711", share: .02 },
            { name: "WSTETH-ETH", address: "0x3BA6A019eD5541b5F5555d8593080042Cf3ae5f4", share: .06, lendRatio: .95 },
            { name: "RETH-ETH", address: "0xE300B3A6b24cB3c5c87034155F7ffF7F77C862a0", share: .05, lendRatio: .95 },
            { name: "SDAI-USDC", address: "0x90Ac6604aE71B5D978f3fC6074078987249119Ea", share: .05, lendRatio: .95 },
            { name: "YFI-DAI", address: "0x66ea46c6e7f9e5bb065bd3b1090fff229393ba51", share: .02 },
            { name: "st-yETH-DAI", address: "0x304375e4890146dc575b894b35a42608fab823a8", share: .02 },
            { name: "Ajna-DAI", address: "0x2feef99a711d684e00a017c4ac587bea31f12875", share: .025 },
            { name: "MKR-DAI", address: "0x0598c1FeDa47535FF5248E2Bd08703ACE4E740C4", share: .02 },
            { name: "SUSDE-DAI", address: "0x34bc3d3d274a355f3404c5dee2a96335540234de", share: .035, lendRatio: .95 },
            { name: "mwstETH-WPUNKS:20/wstETH", address: "0x1b3ca2a7b12859fe34cefd7072d770fb6a1e7679", share: .005 },
            { name: "mwstETH-WPUNKS:40/wstETH", address: "0x7a2f9d2610ab99952dfb44f8aa3707584baacb8d", share: .005 },
            { name: "UNI-V2 LP ajnaweth/dai", address: "0xc71aD394818474F87f27a5525243de52C278dcb8", share: .03 },
            { name: "mbase/USDC", address: "0x5503364c38505c68612a4d85e952f33cd17e24af", share: .1, lendRatio: .95 }
          ];
          break;
        case Network.Base:
          rewardDistributions = [
            { name: "CBETH-ETH", address: "0xCB1953EE28f89731C0ec088dA0720FC282fCFa9c", share: .05, lendRatio: .95 },
            { name: "ETH-USDC", address: "0x0B17159F2486f669a1F930926638008E2ccB4287", share: .05 },
            { name: "WSTETH-ETH", address: "0x63A366fc5976FF72999C89f69366F388b7D233e8", share: .02, lendRatio: .95 },
            { name: "DEGEN-USDC", address: "0x52e69a7cf5076a769e11fffc2e99e837b575f65e", share: .03 },
            { name: "USDC-DEGEN", address: "0x1dec31e6550c958af3e116f23472fe1493476496", share: .0125 },
            { name: "SNX-USDC", address: "0x92c85b18e7f0df000bbfab4ce76c28a4ddbae64a", share: .0375 },
            { name: "PRIME-USDC", address: "0x2b2b94dc8e974433c7c4ec7741f686eb46584831", share: .02 },
            { name: "AERO-USDC", address: "0x97dbbdba28df6d629bc17e0349bcb73d541ed041", share: .015 }
          ];
          break;
        case Network.Goerli:
          rewardDistributions = [
    ...
    } else if (weekId >= config.rewardStartWeek + 29) {
      switch (network) {
        case Network.Mainnet:
          rewardDistributions = [
            { name: "RETH-DAI", address: "0x9cdB48FcBd8241Bb75887AF04d3b1302c410F671", share: .06 },
            ...
            { name: "mwstETH-WPUNKS:40/wstETH", address: "0x7a2f9d2610ab99952dfb44f8aa3707584baacb8d", share: .005 },
            { name: "UNI-V2 LP ajnaweth/dai", address: "0xc71aD394818474F87f27a5525243de52C278dcb8", share: .03 },
            { name: "syrupUSDC/USDC", address: "0xbcda8ee352778071fc7f09b8bfbcd832aa09cee9", share: .1, lendRatio: .95 }
          ];
          break;
        case Network.Base:
          rewardDistributions = [
    ...
    } else if (weekId >= config.rewardStartWeek + 25) {
      switch (network) {
        case Network.Mainnet:
          rewardDistributions = [
            ...
            { name: "WBTC-USDC", address: "0x3BB7C1E268A51b2D933C0490e282e20b906f8652", share: 0.07 },
            ...
            { name: "WSTETH-ETH", address: "0x3BA6A019eD5541b5F5555d8593080042Cf3ae5f4", share: 0.07, lendRatio: 0.95 },
            ...
            { name: "Ajna-DAI", address: "0x2feef99a711d684e00a017c4ac587bea31f12875", share: 0.035 },
            { name: "MKR-DAI", address: "0x0598c1FeDa47535FF5248E2Bd08703ACE4E740C4", share: 0.03 },
            { name: "SUSDE-DAI", address: "0x34bc3d3d274a355f3404c5dee2a96335540234de", share: 0.035, lendRatio: 0.95 },
            { name: "mwstETH-WPUNKS:20/wstETH", address: "0x1b3ca2a7b12859fe34cefd7072d770fb6a1e7679", share: 0.005 },
            { name: "mwstETH-WPUNKS:40/wstETH", address: "0x7a2f9d2610ab99952dfb44f8aa3707584baacb8d", share: 0.005 },
            { name: "UNI-V2 LP ajnaweth/dai", address: "0xc71aD394818474F87f27a5525243de52C278dcb8", share: 0.03 },
          ];
          break;
        case Network.Base:
          rewardDistributions = [
            ...
            { name: "DEGEN-USDC", address: "0x52e69a7cf5076a769e11fffc2e99e837b575f65e", share: 0.0375 },
            { name: "USDC-DEGEN", address: "0x1dec31e6550c958af3e116f23472fe1493476496", share: 0.015 },
            { name: "SNX-USDC", address: "0x92c85b18e7f0df000bbfab4ce76c28a4ddbae64a", share: 0.0375 },
            { name: "PRIME-USDC", address: "0x2b2b94dc8e974433c7c4ec7741f686eb46584831", share: 0.02 },
            { name: "AERO-USDC", address: "0x97dbbdba28df6d629bc17e0349bcb73d541ed041", share: 0.015 },
          ];
          break;
        case Network.Goerli:
          rewardDistributions = [
    ...
    } else if (weekId >= config.rewardStartWeek + 16) {
      switch (network) {
        case Network.Mainnet:
          rewardDistributions = [
            { name: "RETH-DAI", address: "0x9cdB48FcBd8241Bb75887AF04d3b1302c410F671", share: 0.07 },
    ...
    } else if (weekId >= config.rewardStartWeek + 15) {
      switch (network) {
        case Network.Mainnet:
          rewardDistributions = [
            { name: "RETH-DAI", address: "0x9cdB48FcBd8241Bb75887AF04d3b1302c410F671", share: 0.07 },
        ...
        case Network.Base:
          rewardDistributions = [
            ...
            { name: "ETH-USDC", address: "0x0B17159F2486f669a1F930926638008E2ccB4287", share: 0.08 },
            { name: "WSTETH-ETH", address: "0x63A366fc5976FF72999C89f69366F388b7D233e8", share: 0.02, lendRatio: 0.95 },
            { name: "DEGEN-USDC", address: "0x52e69a7cf5076a769e11fffc2e99e837b575f65e", share: 0.0375 },
            { name: "USDC-DEGEN", address: "0x1dec31e6550c958af3e116f23472fe1493476496", share: 0.015 },
            { name: "SNX-USDC", address: "0x92c85b18e7f0df000bbfab4ce76c28a4ddbae64a", share: 0.0375 },
    ...
    } else if (weekId >= config.rewardStartWeek + 13) {
      switch (network) {
        case Network.Mainnet:
          rewardDistributions = [
            { name: "RETH-DAI", address: "0x9cdB48FcBd8241Bb75887AF04d3b1302c410F671", share: 0.07 },
        ...
        case Network.Base:
          rewardDistributions = [
            ...
            { name: "ETH-USDC", address: "0x0B17159F2486f669a1F930926638008E2ccB4287", share: 0.0375 },
            { name: "WSTETH-ETH", address: "0x63A366fc5976FF72999C89f69366F388b7D233e8", share: 0.02, lendRatio: 0.95 },
            { name: "DEGEN-USDC", address: "0x52e69a7cf5076a769e11fffc2e99e837b575f65e", share: 0.0375 },
            { name: "USDC-DEGEN", address: "0x1dec31e6550c958af3e116f23472fe1493476496", share: 0.0375 },
            { name: "SNX-USDC", address: "0x92c85b18e7f0df000bbfab4ce76c28a4ddbae64a", share: 0.0375 },
            { name: "PRIME-USDC", address: "0x2b2b94dc8e974433c7c4ec7741f686eb46584831", share: 0.02 },
            { name: "AERO-USDC", address: "0x97dbbdba28df6d629bc17e0349bcb73d541ed041", share: 0.0175 },
          ];
          break;
        case Network.Goerli:
          rewardDistributions = [
    ...
    } else if (weekId >= config.rewardStartWeek + 12) {
      switch (network) {
        case Network.Mainnet:
          rewardDistributions = [
            { name: "RETH-DAI", address: "0x9cdB48FcBd8241Bb75887AF04d3b1302c410F671", share: 0.07 },
